classdef ANGLE_UI < handle
    % ANGLE_UI_V5 : Correction Bug Propriétés ZeroLine
    ...
    properties (Access = public)
        ...
        ColGray = [0.8 0.8 0.8];     
        ColCurs = [0.1 0.1 0.1];
        ColEllip = [1 0.4 1]; % Magenta clair
    end
    ...
    properties (Access = private)
        ...
        ZeroLine1, Curs1_Min, Curs1_Max % <--- RAJOUTÉ ICI
        ...
        ZeroLine2, Curs2_Min, Curs2_Max % <--- RAJOUTÉ ICI
    ...
    methods
        ...
        function createUI(obj)
            obj.UIFigure = uifigure('Name', 'Analyse Arbres : Ellipse Transparente', 'Position', [50 50 1400 900]);
